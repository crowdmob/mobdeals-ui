  ...
  _cc: function(callback, offer) {
    MobDeals.Popup.show('new-cc', function(popup) {
      ...
      popup.find('form').submit(function(ev) {
        ...
        $.post(MobDeals.host('core')+'/account/wallet/methods.json', { settle: offer != null, wallet_method: serializedCard, 'purchasable[virtual_good_id]': offer.virtual_good_id, 'purchasable_type': offer.purchasable_type, 'purchasable_id': offer.id }, function(data) {
